...
@RoutePage()
class CoinSellDetailsPage extends StatefulWidget {
  final int coinId; // Add this parameter

  const CoinSellDetailsPage({
    super.key,
    required this.coinId, // Make it required
  });

  @override
  State<CoinSellDetailsPage> createState() => _CoinSellDetailsPageState();
}

class _CoinSellDetailsPageState extends State<CoinSellDetailsPage> {
