...
@RoutePage()
class CoinBuyDetailsPage extends StatefulWidget {
  final int coinId; // Add this parameter

  const CoinBuyDetailsPage({
    super.key,
    required this.coinId, // Make it required
  });

  @override
  State<CoinBuyDetailsPage> createState() => _CoinBuyDetailsPageState();
}

class _CoinBuyDetailsPageState extends State<CoinBuyDetailsPage> {
